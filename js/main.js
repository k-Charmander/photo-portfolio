...
const photos = [
  {
    ...
    category: "landscape",
    title: "안개 낀 산",
    src: "https://picsum.photos/seed/land1/800/600",
  },
  {
    id: 2,
    category: "portrait",
  ...
  },
  {
    ...
    category: "landscape",
    title: "해 질 녘 해변",
    src: "https://picsum.photos/seed/land2/800/600",
  },
  {
    id: 5,
    category: "portrait",
  ...
  },
  {
    ...
    category: "landscape",
    title: "겨울 호수",
    src: "https://picsum.photos/seed/land3/800/600",
  },
...
function render() {
  const items = photos.filter((p) => currentFilter === "all" || p.category === currentFilter);
